...
# flask app director
local_powermeter_file = "/home/roland/Desktop/my_flask_app/powermeter.txt"
...
def ant_scan(file_path=None, device_id=0, device_type=0, auto_create=True):
    ...
    def on_device_data(device, page_name, data):
        ...
        if isinstance(data, PowerData):
            print(f"Power Data {data.instantaneous_power} saved to local")
            with open(local_powermeter_file,"w") as f:
                f.write(f"{data.instantaneous_power}")
